...
3014.L*pow(q, 19)));
 ...
 //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
	...
	dm31 = overlambda * (nures.lambda2 - nures.lambda3);
...
int C33_W1_CP_IO_r1()
{
  ...
  ofstream myfile;
  myfile.open ("res_C33_W1_CP_IO_r1p3.txt");
...
//uniform_real_distribution<> dist1(-0.095, -0.081), dist2(1.017, 1.026), dist3(0.6058, 0.6073), dist4(-0.869, -0.865), dist5(-16.6, -15.); //(*part 1*)
uniform_real_distribution<> dist1(0.3584, 0.3879), dist2(1.04599, 1.12054), dist3(1.14506, 1.14714), dist4(0.004705, 0.006180), dist5(-40.65, -22.45); //(*part 1*)
  ...
  for (int m = 1; m <= 999999999; m++)
  {
	...
	long double ubound[8] = {0.02409, 0.345, 0.584, 2., 0.0000805, 0.002547, 0.00475115, 0.0589965};
	long double dbound[8] = {0.02060, 0.275, 0.44, 0.688889, 0.0000692, 0.002421, 0.00472273, 0.0586435};
